...
import io.github.mandar2812.dynaml.repl.{Cli, Defaults, DynaMLRepl, Scripts}
...
case class DynaML(predef: String = "",
  ...
  : (Res[Any], Seq[(Path, Option[Long])]) = {
    ...
    (Scripts.runScript(wd, path, interp, scriptArgs), interp.watchedFiles)
  }
