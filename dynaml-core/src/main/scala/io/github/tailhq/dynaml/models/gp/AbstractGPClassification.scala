...
import io.github.tailhq.dynaml.models.{ParameterizedLearner, SecondOrderProcessModel}
import io.github.tailhq.dynaml.optimization.{GloballyOptimizable, LaplacePosteriorMode}
