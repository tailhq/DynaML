...
import io.github.tailhq.dynaml.models.neuralnets.{Activation, NeuralStack, NeuralStackFactory}
import io.github.tailhq.dynaml.pipes.{DataPipe, MetaPipe, StreamDataPipe, StreamMapPipe}
