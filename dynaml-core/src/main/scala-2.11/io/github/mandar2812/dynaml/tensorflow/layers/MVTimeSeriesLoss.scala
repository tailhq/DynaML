...
import org.platanios.tensorflow.api.core.types.{IsDecimal, IsFloat32OrFloat64, IsNotQuantized, TF}
...
Predictions: TF : IsNotQuantized : IsFloat32OrFloat64,
L: TF : IsFloat32OrFloat64](
